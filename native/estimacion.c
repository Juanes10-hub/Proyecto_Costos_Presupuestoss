...
static double calcular_costo_personal(int duracion_meses, int tamano_equipo, double salario_promedio) {
    return duracion_meses * tamano_equipo * salario_promedio;
}

static double calcular_costo_infraestructura(int duracion_meses, double infraestructura_mensual) {
    return duracion_meses * infraestructura_mensual;
}

static double calcular_costo_licencias(int duracion_meses, double licencias_mensuales) {
    return duracion_meses * licencias_mensuales;
}

static double calcular_contingencia(double subtotal, double contingencia_porcentaje) {
...
int calcular_estimacion(int duracion_meses, int tamano_equipo, double salario_promedio,
    ...
    if (!resultado || duracion_meses <= 0 || tamano_equipo <= 0 || 
        salario_promedio <= 0 || contingencia_porcentaje < 0) {
        return -1;
    }
    ...
    if (resultado->total_presupuesto > 0) {
